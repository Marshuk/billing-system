...
class Bill_App:
    ...
    self.welcome_bill()
     ...
     #==========BOTTOM=======================================   
    title = Label(self.root, text="BILLING APPLICATION", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#a0a0a0", fg="white", relief=GROOVE)
    title.place(x=300, y=700, width=880, height=105)
    ...
    def total(self):
        ...
        self.total_medical_price = float(self.m_m_p+self.m_h_g_p+self.m_f_p+self.m_b_p+self.m_t_g_p+self.m_s_p)
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\t          Welcome APT Grocery Retail")
